...
- aspects:
	- unequal responsibility for environmental harm
		- certain groups have more responsibility for damage to the environment and climate change
	- unequal distribution of benefits
	- unequal distribution of costs (exposure to toxins, displacement, differences in adaptation capacity)
	- environmental inequality is systematic and tied to existing forms of inequality and injustice
- Types of injustices
	- intergenerational
		- inaction by aging ruling class leaves the responsibility on the younger generation to solve the problem
	- international/global (rich vs poor)
	- within-nation (ethnicity, culture, social class, gender)
	- colonialism
		- many global south countries were colonies by the global north
		- colonialism: resource extraction
		- settler colonialism: influx of citizens to colony + resource extraction
		- former colonies sometimes still have residual economic extraction built into their  institutions
- Unjust solutions?
...
- Ecological footprint per Canadian by earnings decile: as the income spectrum increases so does hectares of ecological footprint; at the 10th deciles (highest earning) the increase is exponential
	- earning is a predictor of expenditure
- Global carbon inequality
	- from 1990-2005 humans doubles the CO2 in the atmosphere (we've only emitted faster since then)
	- richest 1% alone accounted for over 15% of cumulative emissions
		- used up 9% of carbon budget (to stay within 1.5 degrees)
		- 2x emissions of the poorest 50%
	- per capita carbon emissions by different income groups by different region
